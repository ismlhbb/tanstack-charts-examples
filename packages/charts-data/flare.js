// Generated by scripts/sync-demo-data.mjs from flare.csv.
...
export const flare = [
  ...
  {name: "flare.analytics.graph", size: null},
  ...
  {name: "flare.analytics.optimization", size: null},
  {name: "flare.analytics.optimization.AspectRatioBanker", size: 7074},
  {name: "flare.animate", size: null},
  ...
  {name: "flare.flex", size: null},
  {name: "flare.flex.FlareVis", size: 4116},
  {name: "flare.physics", size: null},
  ...
  {name: "flare.query.methods", size: null},
  ...
  {name: "flare.vis.legend", size: null},
  ...
  {name: "flare.vis.operator", size: null},
  ...
  {name: "flare.vis.operator.filter", size: null},
  ...
  {name: "flare.vis.operator.layout", size: null},
